...
rev = pd.read_csv('I:/Projekte/OpenEntrance - WV0173/Durchführungsphase/WP6/CS1/OE_data_analysis/openEntrance/data/EV NUTS projectionsV4.csv',sep=",",encoding = "ISO-8859-1", header=0, index_col=False) 
...
wunit_ev = wunit_ev.drop(['country','evLIFE_150kkm'], axis=1)
...
p_EV.to_csv(r'I:/Projekte/OpenEntrance - WV0173/Durchführungsphase/WP6/CS1/OE_data_analysis/openEntrance/data/theoretical potential/p_EVV5.csv')       
d_EV.to_csv(r'I:/Projekte/OpenEntrance - WV0173/Durchführungsphase/WP6/CS1/OE_data_analysis/openEntrance/data/theoretical potential/d_EVV5.csv')   
