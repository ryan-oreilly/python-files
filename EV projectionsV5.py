...
#########################################     
#from T&E 2021
rEV_path =  pd.read_excel("I:/Projekte/OpenEntrance - WV0173/Durchführungsphase/WP6/CS1/OE_data_analysis/openEntrance/data/EV_NVF_EV_path.xlsx", sheet_name = "2021 T&E final")
...
#save to file
yrEV.to_csv(r'EV NVF projectionsV2.csv')  
...
#save to file
EV_NHH.to_csv(r'EV from NHHV5_ave.csv')  
EV_rem.to_csv(r'EV discontinuedV5_ave.csv')  
EV.to_csv(r'EV projectionsV5_ave.csv')  
